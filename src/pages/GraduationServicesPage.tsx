...
export function GraduationServicesPage() {
  ...
  const handleNext = () => {
    ...
    if (selectedServices.length > 0) {
      navigate('/events/create/graduation/places', {
      ...
      <div className="max-w-7xl mx-auto px-4">
        <div className="text-center mb-12">
          <h1 className="text-5xl font-bold text-white mb-4">
            <span className="text-pink-500">Graduation</span> Services
          </h1>
          <p className="text-xl text-gray-300">
            Select the services to make your graduation celebration memorable
          </p>
        </div>
