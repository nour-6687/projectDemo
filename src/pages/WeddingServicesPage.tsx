...
export function WeddingServicesPage() {
  ...
  const handleNext = () => {
    ...
    if (selectedServices.length > 0) {
      navigate('/events/create/wedding/places', {
      ...
      <div className="max-w-7xl mx-auto px-4">
        <div className="text-center mb-12">
          <h1 className="text-5xl font-bold text-white mb-4">
            <span className="text-pink-500">Wedding</span> Services
          </h1>
          <p className="text-xl text-gray-300">
            Select what you want to reserve
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
          {services.map((service) => (
            ...
            >
              ...
              />
              <div className="absolute inset-0 bg-gradient-to-t from-purple-950/90 to-purple-950/20" />
        ...
        <div className="flex justify-center">
          <button
            onClick={handleNext}
            className="px-12 py-3 bg-gradient-to-r from-purple-600 to-pink-500 text-white rounded-xl hover:from-purple-500 hover:to-pink-400 transition-all text-lg font-medium"
          >
            NEXT
          </button>
        </div>
