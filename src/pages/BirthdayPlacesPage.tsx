...
export function BirthdayPlacesPage() {
  ...
  const places: Place[] = [
    // Pastry Shops
    {
      ...
      rating: 4.9,
      address: '123 Baker Street, Manhattan, NY 10001',
    ...
    },
    {
      ...
      name: 'Cake Paradise',
      rating: 4.8,
      address: '456 Dessert Lane, Manhattan, NY 10002',
      image: 'https://images.unsplash.com/photo-1464195244916-405fa0a82545?auto=format&fit=crop&q=80',
      category: 'pastry'
    },
    {
      id: 'pastry3',
      name: 'Birthday Bake Shop',
      rating: 4.7,
      address: '789 Celebration Ave, Manhattan, NY 10003',
    ...
    // Halls
    {
      ...
      name: 'Party Palace',
      rating: 4.9,
      address: '321 Celebration Blvd, Manhattan, NY 10004',
    ...
    },
    {
      ...
      name: 'Fun Factory',
      rating: 4.8,
      address: '654 Entertainment St, Manhattan, NY 10005',
    ...
    },
    {
      ...
      name: 'Kids Kingdom',
      rating: 4.7,
      address: '987 Play Place, Manhattan, NY 10006',
    ...
    // Beauty Centers
    {
      ...
      name: 'Glamour Spa',
      rating: 4.9,
      address: '741 Beauty Blvd, Los Angeles, CA 90001',
      image: 'https://images.unsplash.com/photo-1560750588-73207b1ef5b8?auto=format&fit=crop&q=80',
      category: 'beauty'
    },
    {
      id: 'beauty2',
      name: 'Party Prep Salon',
      rating: 4.8,
      address: '852 Glam Street, Los Angeles, CA 90002',
    ...
    // Barber Shops
    {
      ...
      name: 'Style Studio',
      rating: 4.8,
      address: '159 Cut Corner, Chicago, IL 60601',
    ...
    },
    {
      ...
      name: 'Modern Cuts',
      rating: 4.7,
      address: '263 Trim Trail, Chicago, IL 60602',
    ...
    },
    {
      ...
      rating: 4.8,
      address: '485 Makeup Lane, Miami, FL 33102',
